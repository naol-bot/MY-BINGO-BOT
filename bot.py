...
# 1. ቶከንህን ከ @BotFather አምጥተህ እዚህ " " ውስጥ አስገባ
...
# ተጫዋቾች ማስረጃ ሲልኩ ለአንተ (ለዋሲሁን) ይተላለፋል
...
def admin_approval(call):
    ...
    if call.data.startswith("app_"):
        bot.send_message(user_id, "🎉 የላኩት ክፍያ ተረጋግጧል! አሁን መጫወት ይችላሉ።")
    else:
        bot.send_message(user_id, "❌ ይቅርታ፣ የላኩት ማስረጃ ተቀባይነት አላገኘም።")
